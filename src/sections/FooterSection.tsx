  ...
  return (
    <footer className="border-t border-slate-200 py-8">
      <Container className="flex flex-col items-center justify-between gap-4 sm:flex-row">
        <div className="flex w-full flex-col items-center gap-2 text-center sm:w-auto sm:flex-row sm:items-center sm:gap-3 sm:text-left">
          <img
            src={DUTYFLEX_LOGO_URL}
            alt="DutyFlex logo"
            className="h-8 w-auto max-w-[180px] object-contain sm:h-7 sm:max-w-none"
          />
          <div className="flex flex-wrap items-center justify-center gap-2 text-center text-xs leading-relaxed text-slate-500 sm:flex-nowrap sm:justify-start sm:text-left sm:text-sm">
        ...
        <nav className="flex w-full flex-col items-center justify-center gap-1 text-xs text-slate-500 sm:w-auto sm:flex-row sm:gap-2 sm:text-sm">
          <Link
